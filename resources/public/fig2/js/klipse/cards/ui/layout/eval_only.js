...
var x38359_38369 = klipse.cards.ui.layout.eval_only.Root_computed.prototype;
x38359_38369.componentWillUpdate = ((function (x38359_38369){
...
var ident__19923__auto___38370 = om.next.ident.call(null,this__19919__auto__,om.next.props.call(null,this__19919__auto__));
var next_ident__19924__auto___38371 = om.next.ident.call(null,this__19919__auto__,om.next._next_props.call(null,next_props__19920__auto__,this__19919__auto__));
if(cljs.core.not_EQ_.call(null,ident__19923__auto___38370,next_ident__19924__auto___38371)){
var idxr__19925__auto___38372 = cljs.core.get_in.call(null,om.next.get_reconciler.call(null,this__19919__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"indexer","indexer",-1774914315)], null));
if((idxr__19925__auto___38372 == null)){
} else {
cljs.core.swap_BANG_.call(null,new cljs.core.Keyword(null,"indexes","indexes",1496475545).cljs$core$IFn$_invoke$arity$1(idxr__19925__auto___38372),((function (idxr__19925__auto___38372,ident__19923__auto___38370,next_ident__19924__auto___38371,this__19919__auto__,x38359_38369){
return (function (indexes__19926__auto__){
return cljs.core.update_in.call(null,cljs.core.update_in.call(null,indexes__19926__auto__,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),ident__19923__auto___38370], null),cljs.core.disj,this__19919__auto__),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ref->components","ref->components",-303587249),next_ident__19924__auto___38371], null),cljs.core.fnil.call(null,cljs.core.conj,cljs.core.PersistentHashSet.EMPTY),this__19919__auto__);
});})(idxr__19925__auto___38372,ident__19923__auto___38370,next_ident__19924__auto___38371,this__19919__auto__,x38359_38369))
);
}
} else {
}
...
x38359_38369.shouldComponentUpdate = ((function (x38359_38369){
return (function (next_props__19920__auto__,next_state__19921__auto__){
var this__19919__auto__ = this;
...
var next_props__19920__auto____$2 = (function (){var G__38361 = next_props__19920__auto____$1;
if((next_props__19920__auto____$1 instanceof om.next.OmProps)){
return om.next.unwrap.call(null,G__38361);
} else {
return G__38361;
}
})();
...
x38359_38369.componentWillUnmount = ((function (x38359_38369){
return (function (){
var this__19919__auto__ = this;
...
x38359_38369.componentDidUpdate = ((function (x38359_38369){
...
x38359_38369.isMounted = ((function (x38359_38369){
return (function (){
var this__19919__auto__ = this;
...
x38359_38369.componentWillMount = ((function (x38359_38369){
return (function (){
var this__19919__auto__ = this;
...
x38359_38369.render = ((function (x38359_38369){
return (function (){
var this__19918__auto__ = this;
var this$ = this__19918__auto__;
var _STAR_reconciler_STAR_38362 = om.next._STAR_reconciler_STAR_;
var _STAR_depth_STAR_38363 = om.next._STAR_depth_STAR_;
var _STAR_shared_STAR_38364 = om.next._STAR_shared_STAR_;
var _STAR_instrument_STAR_38365 = om.next._STAR_instrument_STAR_;
var _STAR_parent_STAR_38366 = om.next._STAR_parent_STAR_;
...
}finally {om.next._STAR_parent_STAR_ = _STAR_parent_STAR_38366;

om.next._STAR_instrument_STAR_ = _STAR_instrument_STAR_38365;

om.next._STAR_shared_STAR_ = _STAR_shared_STAR_38364;

om.next._STAR_depth_STAR_ = _STAR_depth_STAR_38363;

om.next._STAR_reconciler_STAR_ = _STAR_reconciler_STAR_38362;
}});})(x38359_38369))
;
...
var x38367_38373 = klipse.cards.ui.layout.eval_only.Root_computed;


var x38368_38374 = klipse.cards.ui.layout.eval_only.Root_computed.prototype;
...
klipse.cards.ui.layout.eval_only.Root_computed.cljs$lang$ctorPrWriter = (function (this__20079__auto__,writer__20080__auto__,opt__20081__auto__){
return cljs.core._write.call(null,writer__20080__auto__,"klipse.cards.ui.layout.eval-only/Root-computed");
});
klipse.cards.ui.layout.eval_only.root_computed = om.next.factory.call(null,klipse.cards.ui.layout.eval_only.Root_computed);

//# sourceMappingURL=eval_only.js.map
