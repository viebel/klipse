...
var digit_23020 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_23021__$1 = (vlq >>> (5));
while(true){
if((vlq_23021__$1 > (0))){
var digit_23022__$1 = (digit_23020 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_23022__$1));

var G__23023 = (vlq_23021__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__23024 = (vlq_23021__$1 >>> (5));
digit_23020 = G__23023;
vlq_23021__$1 = G__23024;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_23020));
}
break;
}
...
var G__23025 = i__$1;
var G__23026 = result__$1;
var G__23027 = shift__$1;
i = G__23025;
result = G__23026;
shift = G__23027;
continue;
