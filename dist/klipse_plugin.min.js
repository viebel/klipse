...
function oe(a) {
  return null != a ? a.v & 2 || a.kg ? !0 : a.v ? !1 : A(yc, a) : A(yc, a);
}
function pe(a) {
...
H.j = function(a, b) {
  return null == a ? null : null != a && (a.v & 256 || a.pg) ? a.N(null, b) : mc(a) ? b < a.length ? a[b | 0] : null : "string" === typeof a ? b < a.length ? a[b | 0] : null : A(Jc, a) ? Kc.j(a, b) : null;
};
H.l = function(a, b, c) {
  return null != a ? null != a && (a.v & 256 || a.pg) ? a.M(null, b, c) : mc(a) ? b < a.length ? a[b] : c : "string" === typeof a ? b < a.length ? a[b] : c : A(Jc, a) ? Kc.l(a, b, c) : c : c;
};
H.L = 3;
var U = function U(b) {
  for (var c = [], d = arguments.length, e = 0;;) {
...
function Oe(a) {
  return null == a ? !1 : null != a ? a.v & 1024 || a.qg ? !0 : a.v ? !1 : A(Oc, a) : A(Oc, a);
}
function Qe(a) {
...
function ff(a, b) {
  return null != b && (b.v & 524288 || b.sg) ? b.va(null, a) : mc(b) ? le(b, a) : "string" === typeof b ? le(b, a) : A(ed, b) ? fd.j(b, a) : ye(a, b);
}
function uc(a, b, c) {
  return null != c && (c.v & 524288 || c.sg) ? c.wa(null, a, b) : mc(c) ? me(c, a, b) : "string" === typeof c ? me(c, a, b) : A(ed, c) ? fd.l(c, a, b) : Ae(a, b, c);
}
function gf(a, b) {
  var c = ["^ "];
...
var Yf = function Yf() {
  ...
  }, Xb.Db = !0, Xb.ob = "cljs.core/t_cljs$core58694", Xb.Rb = function(b, c) {
    return qd(c, "cljs.core/t_cljs$core58694");
  });
  return new Xb(Yf, cg);
};
function dg(a, b) {
...
h.sd = function(a, b) {
  if (z(this.Vc)) {
    if (null != b ? b.v & 2048 || b.rg || (b.v ? 0 : A(Qc, b)) : A(Qc, b)) {
...
function fj(a) {
  return (null != a ? a.ng || (a.Ge ? 0 : A(dj, a)) : A(dj, a)) ? ej(a) : "string" === typeof a || "number" === typeof a || a instanceof X || a instanceof F ? gj.h ? gj.h(a) : gj.call(null, a) : aj(S([a], 0), bc());
}
var gj = function gj(b) {
  if (null == b) {
    return null;
  }
  if (null != b ? b.ng || (b.Ge ? 0 : A(dj, b)) : A(dj, b)) {
    return ej(b);
  }
  if (b instanceof X) {
    return Cf(b);
...
-1372888156), mk = new X(null, "compact-max-chars-in-str", "compact-max-chars-in-str", 240586724), nk = new X(null, "opt-keys", "opt-keys", 1262688261), ok = new F(null, "aform", "aform", 531303525, null), pk = new F(null, "blockable", "blockable", -28395259, null), fc = new X(null, "dup", "dup", 556298533), qk = new X(null, "editor-type", "editor-type", 198227301), rk = new X(null, "jsCode", "jsCode", -574022139), sk = new X(null, "element", "element", 1974019749), tk = new X(null, "patch", "patch", 
380775109), uk = new X(null, "out-mode", "out-mode", -446316699), vk = new X("klipse.plugin", "eval_idle_msec", "klipse.plugin/eval_idle_msec", 15935397), wk = new X("klipse.klipse-editors", "editor-mode", "klipse.klipse-editors/editor-mode", -1678175194), xk = new F(null, "opt", "opt", 845825158, null), yk = new F(null, "argspec", "argspec", -1207762746, null), zk = new X(null, "private", "private", -558947994), Ak = new X(null, "editor-out-mode", "editor-out-mode", 1749845542), Bk = new X(null, 
"cljs_in", "cljs_in", 1284321894), Ck = new X("cljs.spec", "k", "cljs.spec/k", 668466950), Dk = new X(null, "response-type", "response-type", -1493770458), Ek = new X(null, "reset", "reset", -800929946), Fk = new X(null, "protocol", "protocol", 652470118), Gk = new F(null, "map-spec-impl", "map-spec-impl", -1682885722, null), Ik = new X(null, "ks", "ks", 1900203942), Jk = new X(null, "print_length", "print_length", 2140955911), Kk = new F(null, "req-un", "req-un", -1579864761, null), Lk = new F(null, 
"opt-un", "opt-un", -1770993273, null), Mk = new X(null, "password", "password", 417022471), Nk = new X(null, "transit-params", "transit-params", 357261095), Ok = new F(null, "p1__66661#", "p1__66661#", 1956445031, null), rg = new X(null, "validator", "validator", -1966190681), Pk = new X(null, "method", "method", 55703592), Qk = new X(null, "default", "default", -1987822328), Rk = new X(null, "finally-block", "finally-block", 832982472), Tk = new F(null, "cb", "cb", -2064487928, null), Uk = new X(null, 
"replit-language", "replit-language", -941391192), Vk = new X(null, "on-should-eval", "on-should-eval", 978880168), Wk = new X(null, "matchBrackets", "matchBrackets", 1256448936), Xk = new X("klipse.plugin", "klipse-settings", "klipse.plugin/klipse-settings", 1435250729), Yk = new X(null, "name", "name", 1843675177), Zk = new X(null, "as", "as", 1148689641), $k = new F(null, "zipmap", "zipmap", -690049687, null), al = new F("cljs.core", "string?", "cljs.core/string?", -2072921719, null), bl = new X(null, 
"encoding-opts", "encoding-opts", -1805664631), cl = new X(null, "beautify-strings", "beautify-strings", -236207479), dl = new X(null, "req-specs", "req-specs", 553962313), el = new F(null, "gfn", "gfn", -1862918295, null), fl = new F(null, "meta61309", "meta61309", 671177641, null), gl = new X(null, "callback-name", "callback-name", 336964714), hl = new F(null, "fnspec", "fnspec", -1865712406, null), il = new F(null, "v", "v", 1661996586, null), jl = new X(null, "username", "username", 1605666410), 
kl = new F(null, "pred-exprs", "pred-exprs", -862164374, null), ll = new F(null, "keys-pred", "keys-pred", -1795451030, null), ml = new X(null, "beautify?", "beautify?", 1909100619), nl = new X(null, "cwd", "cwd", 14056523), ol = new X(null, "mode", "mode", 654403691), pl = new X(null, "loaded", "loaded", -1246482293), ql = new F("goog.dom", "isElement", "goog.dom/isElement", -1707224949, null), rl = new F(null, "cpred?", "cpred?", 35589515, null), sl = new X(null, "compact-max-elements-in-seq", 
"compact-max-elements-in-seq", 418251211), tl = new X(null, "editor_type", "editor_type", 195783179), ul = new F(null, "argm", "argm", -181546357, null), vl = new F(null, "map__66105", "map__66105", 201100971, null), wl = new X(null, "settings", "settings", 1556144875), xl = new X(null, "max-function-calls", "max-function-calls", -350003092), yl = new X(null, "channel", "channel", 734187692), cj = new X(null, "val", "val", 128701612), zl = new F(null, "fform", "fform", -176049972, null), Z = new X(null, 
"recur", "recur", -437573268), bg = new F(null, "meta58695", "meta58695", -215556724, null), Al = new F(null, "opt-keys", "opt-keys", -1391747508, null), Bl = new X(null, "catch-block", "catch-block", 1175212748), Cl = new X(null, "delete", "delete", -1768633620), Dl = new X(null, "min-eval-idle-msec", "min-eval-idle-msec", -1547033812), El = new F(null, "p__66073", "p__66073", -894979252, null), Fl = new X(null, "compilationLevel", "compilationLevel", -1778317460), Gl = new F(null, "pred", "pred", 
-727012372, null), Hl = new X(null, "src", "src", -1651076051), Il = new X(null, "warnings", "warnings", -735437651), $i = new X(null, "fallback-impl", "fallback-impl", -1501286995), Jl = new F("cljs.core", "contains?", "cljs.core/contains?", -976526835, null), Kl = new X(null, "comment-str", "comment-str", 130143853), Ll = new F("cljs.core", "map?", "cljs.core/map?", -1390345523, null), Ml = new X(null, "handlers", "handlers", 79528781), cc = new X(null, "flush-on-newline", "flush-on-newline", -151457939), 
Nl = new X(null, "skip-wiki", "skip-wiki", -2018833298), Ol = new X(null, "port", "port", 1534937262), Pl = new F("cljs.core", "zipmap", "cljs.core/zipmap", -1902130674, null), Ql = new X(null, "minimalistic_ui", "minimalistic_ui", -944637362), Rl = new X(null, "abort", "abort", 521193198), Sl = new X(null, "base-url", "base-url", 9540398), Tl = new F(null, "alt-flag", "alt-flag", -1794972754, null), Ul = new F(null, "%", "%", -950237169, null), Vl = new X(null, "in-mode", "in-mode", 33987599), Wl = 
new X("cljs.spec", "pcat", "cljs.spec/pcat", -1959753649), Xl = new X(null, "source-code", "source-code", -685884337), Yl = new F("cljs.core", "map", "cljs.core/map", -338988913, null), oj = new X(null, "descendants", "descendants", 1824886031), Zl = new F(null, "meta66150", "meta66150", 586664463, null), $l = new F("cljs.spec", "conformer", "cljs.spec/conformer", -236330417, null), am = new X(null, "http-error", "http-error", -1040049553), bm = new F("cljs.core", "fn?", "cljs.core/fn?", 71876239, 
null), cm = new X(null, "headers", "headers", -835030129), dm = new X(null, "server-port", "server-port", 663745648), pj = new X(null, "ancestors", "ancestors", -776045424), em = new F(null, "flag", "flag", -1565787888, null), fm = new F(null, "req-specs", "req-specs", -2100473456, null), gm = new X(null, "no-error", "no-error", 1984610064), dc = new X(null, "readably", "readably", 1129599760), hm = new X(null, "error-code", "error-code", 180497232), im = new F(null, "box", "box", -1123515375, null), 
Ri = new X(null, "more-marker", "more-marker", -14717935), jm = new X(null, "document", "document", -1329188687), km = new F(null, "re", "re", 1869207729, null), lm = new F("klipse.plugin", "klipsify-with-opts", "klipse.plugin/klipsify-with-opts", 331340081, null), mm = new X(null, "head", "head", -771383919), nm = new F(null, "meta66108", "meta66108", -804378095, null), om = new X(null, "req", "req", -326448303), pm = new X(null, "host", "host", -1558485167), qm = new X(null, "blob", "blob", 1636965233), 
rm = new X(null, "default-headers", "default-headers", -43146094), sm = new X(null, "total", "total", 1916810418), tm = new X(null, "with-credentials?", "with-credentials?", -1773202222), um = new X("cljs.spec", "name", "cljs.spec/name", -1902005006), vm = new F("cljs.core", "integer?", "cljs.core/integer?", 1710697810, null), wm = new X("cljs.spec", "unknown", "cljs.spec/unknown", -1620309582), xm = new X(null, "beautify_strings", "beautify_strings", 1690445266), ym = new X(null, "keys", "keys", 
1068423698), zm = new X(null, "ff-silent-error", "ff-silent-error", 189390514), Am = new X(null, "success", "success", 1890645906), Bm = new X("klipse.plugin", "options", "klipse.plugin/options", 1158769650), Cm = new X(null, "form-params", "form-params", 1884296467), Dm = new X(null, "priority", "priority", 1431093715), Em = new X(null, "readOnly", "readOnly", -1749118317), Fm = new F(null, "fn*", "fn*", -752876845, null), Gm = new F(null, "val", "val", 1769233139, null), Hm = new X(null, "root", 
"root", -448657453), Im = new X(null, "status", "status", -1997798413), gc = new X(null, "print-length", "print-length", 1931866356), Jm = new X(null, "ok", "ok", 967785236), Km = new X(null, "codemirror-options-out", "codemirror-options-out", 1969968980), Lm = new F(null, "fspec-impl", "fspec-impl", 897021908, null), Mm = new X(null, "decoding-opts", "decoding-opts", 1050289140), Nm = new X(null, "catch-exception", "catch-exception", -1997306795), Om = new X(null, "opts", "opts", 155075701), Pm = 
new X("klipse.plugin", "minimalistic_ui", "klipse.plugin/minimalistic_ui", 231935317), Qm = new F(null, "meta61315", "meta61315", 1154121205, null), nj = new X(null, "parents", "parents", -2027538891), Rm = new F(null, "/", "/", -1371932971, null), Sm = new F(null, "keys-\x3especs", "keys-\x3especs", -97897643, null), Tm = new X(null, "req-keys", "req-keys", 514319221), Um = new F(null, "k", "k", -505765866, null), Vm = new X(null, "prev", "prev", -1597069226), Wm = new F("klipse.klipse-editors", 
"editor-options", "klipse.klipse-editors/editor-options", 1970701494, null), Xm = new F("cljs.core", "fn", "cljs.core/fn", -1065745098, null), Ym = new X(null, "url", "url", 276297046), Zm = new X(null, "editor-in-mode", "editor-in-mode", -1964584522), $m = new X(null, "continue-block", "continue-block", -1852047850), an = new X(null, "error-text", "error-text", 2021893718), bn = new F(null, "retspec", "retspec", -920025354, null), cn = new X("cljs.spec", "accept", "cljs.spec/accept", -1753298186), 
dn = new X(null, "query-params", "query-params", 900640534), en = new X(null, "opt-specs", "opt-specs", -384905450), fn = new X(null, "in-editor-options", "in-editor-options", -1444530378), gn = new X(null, "content-type", "content-type", -508222634), hn = new X(null, "http", "http", 382524695), jn = new X(null, "timeslot-function-calls-msec", "timeslot-function-calls-msec", 189712759), kn = new X(null, "oauth-token", "oauth-token", 311415191), ln = new X(null, "context", "context", -830191113), 
mn = new X(null, "post", "post", 269697687), nn = new F("cljs.spec", "cat", "cljs.spec/cat", 850003863, null), on = new F(null, "meta66634", "meta66634", -41905225, null), pn = new X(null, "options-out", "options-out", 781271031), qn = new F(null, "rform", "rform", -1420499912, null), rn = new X(null, "pred-forms", "pred-forms", 172611832), sn = new F(null, "req", "req", 1314083224, null), tn = new X(null, "error", "error", -978969032), un = new X("klipse.plugin", "comment-str", "klipse.plugin/comment-str", 
1428350840), vn = new X(null, "cancel", "cancel", -1964088360), wn = new X(null, "exception", "exception", -335277064), xn = new X(null, "scrollbarStyle", "scrollbarStyle", -963515367), yn = new X("cljs.spec", "gfn", "cljs.spec/gfn", -432034727), zn = new X(null, "uri", "uri", -774711847), An = new X(null, "tag", "tag", -1290361223), Bn = new X(null, "anchor", "anchor", 1549638489), Cn = new X(null, "decoding", "decoding", -568180903), Dn = new X(null, "server-name", "server-name", -1012104295), 
En = new X(null, "put", "put", 1299772570), Fn = new X(null, "json", "json", 1279968570), ag = new F(null, "quote", "quote", 1377916282, null), Gn = new F(null, "alt-handler", "alt-handler", 963786170, null), Hn = new X(null, "timeout", "timeout", -318625318), In = new X(null, "eval-fn", "eval-fn", -1111644294), $f = new X(null, "arglists", "arglists", 1661989754), Jn = new X(null, "query", "query", -1288509510), Kn = new X(null, "transit-opts", "transit-opts", 1104386010), Ln = new X(null, "query-string", 
"query-string", -1018845061), Zf = new F(null, "nil-iter", "nil-iter", 1101030523, null), Mn = new F(null, "id", "id", 252129435, null), Nn = new X(null, "progress", "progress", 244323547), On = new X(null, "out-editor-options", "out-editor-options", -95308421), Pn = new X(null, "hierarchy", "hierarchy", -1053470341), Qn = new X(null, "body", "body", -2049205669), Rn = new F(null, "meta61161", "meta61161", -1631679781, null), Zi = new X(null, "alt-impl", "alt-impl", 670969595), Sn = new F("cljs.spec", 
"fspec", "cljs.spec/fspec", 982220571, null), Tn = new F(null, "fn-handler", "fn-handler", 648785851, null), Un = new X(null, "doc", "doc", 1913296891), Vn = new F(null, "specs", "specs", -1227865028, null), Wn = new F(null, "meta61129", "meta61129", 1114945660, null), Xn = new X(null, "array-buffer", "array-buffer", 519008380), Yn = new F(null, "p1__66660#", "p1__66660#", -1255949092, null), Zn = new F(null, "req-keys", "req-keys", -2140116548, null), $n = new X(null, "download", "download", -300081668), 
ao = new X(null, "edn-params", "edn-params", 894273052), bo = new X("cljs.spec", "op", "cljs.spec/op", 939378204), kj = new X(null, "keywordize-keys", "keywordize-keys", 1310784252), co = new F(null, "meta66650", "meta66650", -1687827684, null), eo = new X("cljs.spec", "v", "cljs.spec/v", -1491964132), fo = new X(null, "basic-auth", "basic-auth", -673163332), go = new F(null, "deref", "deref", 1494944732, null), ho = new X(null, "codemirror_options_in", "codemirror_options_in", -1220877316), io = 
new X("klipse.plugin", "editor-in-mode", "klipse.plugin/editor-in-mode", -880426851), jo = new X(null, "multipart-params", "multipart-params", -1033508707), ko = new F(null, "meta61264", "meta61264", -775632707, null), lo = new X("klipse.plugin", "editor-out-mode", "klipse.plugin/editor-out-mode", 724274461), mo = new X(null, "custom-error", "custom-error", -1565161123), no = new F(null, "opt-specs", "opt-specs", 1255626077, null), oo = new X(null, "scheme", "scheme", 90199613), po = new F("cljs.core", 
"or", "cljs.core/or", 1201033885, null), qo = new X(null, "trace-redirects", "trace-redirects", -1149427907), ro = new X(null, "keywordize-keys?", "keywordize-keys?", -254545987), so = new X(null, "direction", "direction", -633359395), to = new X(null, "eval_idle_msec", "eval_idle_msec", 1104296094), uo = new X(null, "access-denied", "access-denied", 959449406), vo = new X(null, "upload", "upload", -255769218), wo = new X(null, "request-method", "request-method", 1764796830), xo = new X(null, "forms", 
"forms", 2045992350), yo = new X(null, "dom", "dom", -1236537922), zo = new X(null, "cmd-chan", "cmd-chan", -1229050306), Ao = new X(null, "ps", "ps", 292358046), Bo = new F(null, "k-\x3es", "k-\x3es", -1685112801, null), Co = new X(null, "codemirror-options-in", "codemirror-options-in", -1261564801), Do = new X("cljs.spec", "kvs-\x3emap", "cljs.spec/kvs-\x3emap", -1189105441), Eo = new X(null, "compiledCode", "compiledCode", -1391179489), Fo = new X("klipse.plugin", "dom-element", "klipse.plugin/dom-element", 
-271611585), Go = new X(null, "html", "html", -998796897), Ho = new X(null, "accept", "accept", 1874130431), Io = new X(null, "opt", "opt", -794706369), Jo = new X(null, "text", "text", -1790561697), Ko = new F(null, "pred-forms", "pred-forms", 1813143359, null), Lo = new F(null, "f", "f", 43394975, null);
function Mo(a, b) {
...
if ("undefined" === typeof Wo) {
  var Wo = new q(null, 4, [xl, 50, jn, 1E3, sl, 5, mk, 10], null)
}
;hc();
var Xo = S([xl, 100], 0), Yo = null != Xo && (Xo.v & 64 || Xo.R) ? Rf(qg, Xo) : Xo, Wo = Ai.A(S([Wo, Yo], 0));
console.info("KLIPSE version:", "3.1.7");
function Zo(a) {
...
function at(a, b) {
  ...
  z(z(d) ? 1 !== c.length : d) ? c = Xd.j(pf(c, 0, c.indexOf("/")), pf(c, c.indexOf("/") + 1, c.length)) : (d = Xd.h(c), c = "nil" === c ? null : "true" === c ? !0 : "false" === c ? !1 : "/" === c ? Rm : d);
  return c;
}
function bt(a, b) {
...
function Es(a) {
  return '"' === a ? Zs : ":" === a ? ct : ";" === a ? Fs : "'" === a ? dt(ag) : "@" === a ? dt(go) : "^" === a ? ft : "`" === a ? Rs : "~" === a ? Rs : "(" === a ? Ws : ")" === a ? Vs : "[" === a ? Xs : "]" === a ? Vs : "{" === a ? Ys : "}" === a ? Vs : "\\" === a ? bt : "#" === a ? Ss : null;
}
function Ts(a) {
...
;function fv(a) {
  ...
  a = H.j(b, oo);
  var c = H.j(b, Dn), d = H.j(b, dm), e = H.j(b, zn), b = H.j(b, Ln), f = E, g = new zr;
  Ar(g, Cf(z(a) ? a : hn));
  Cr(g, c);
  Dr(g, d);
  Er(g, e);
...
;var Lv, Mv = function Mv(b) {
  "undefined" === typeof Lv && (Lv = function(b, d, e) {
    ...
    return new V(null, 3, 5, W, [xe(im, new q(null, 1, [$f, xf(ag, xf(new V(null, 1, 5, W, [Gm], null)))], null)), Gm, Wn], null);
  }, Lv.Db = !0, Lv.ob = "cljs.core.async.impl.channels/t_cljs$core$async$impl$channels61128", Lv.Rb = function(b, d) {
    return qd(d, "cljs.core.async.impl.channels/t_cljs$core$async$impl$channels61128");
  });
...
;var Uv, Vv = function Vv(b) {
  "undefined" === typeof Uv && (Uv = function(b, d, e) {
    ...
    return new V(null, 3, 5, W, [xe(Tn, new q(null, 2, [zk, !0, $f, xf(ag, xf(new V(null, 1, 5, W, [Lo], null)))], null)), Lo, Rn], null);
  }, Uv.Db = !0, Uv.ob = "cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers61160", Uv.Rb = function(b, d) {
    return qd(d, "cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers61160");
  });
...
h.V = function(a, b, c) {
  ...
  }(this), "#cljs.core.async.impl.ioc-helpers.ExceptionFrame{", ", ", "}", c, Nf.j(new V(null, 5, 5, W, [new V(null, 2, 5, W, [Bl, this.Bb], null), new V(null, 2, 5, W, [Nm, this.Cb], null), new V(null, 2, 5, W, [Rk, this.Gb], null), new V(null, 2, 5, W, [$m, this.Fb], null), new V(null, 2, 5, W, [Vm, this.Lb], null)], null), this.ca));
};
h.mb = function() {
  return new uh(0, this, 5, new V(null, 5, 5, W, [Bl, Nm, Rk, $m, Vm], null), Id(this.ca));
};
h.O = function() {
  return this.sa;
};
...
h.Tc = function(a, b) {
  return Ze(new Ci(null, new q(null, 5, [Rk, null, Bl, null, Nm, null, Vm, null, $m, null], null), null), b) ? Ge.j(xe(Ig.j(cg, this), this.sa), b) : new $v(this.Bb, this.Cb, this.Gb, this.Fb, this.Lb, this.sa, Xf(Ge.j(this.ca, b)), null);
};
h.Qb = function(a, b, c) {
  return z(Y.j ? Y.j(Bl, b) : Y.call(null, Bl, b)) ? new $v(c, this.Cb, this.Gb, this.Fb, this.Lb, this.sa, this.ca, null) : z(Y.j ? Y.j(Nm, b) : Y.call(null, Nm, b)) ? new $v(this.Bb, c, this.Gb, this.Fb, this.Lb, this.sa, this.ca, null) : z(Y.j ? Y.j(Rk, b) : Y.call(null, Rk, b)) ? new $v(this.Bb, this.Cb, c, this.Fb, this.Lb, this.sa, this.ca, null) : z(Y.j ? Y.j($m, b) : Y.call(null, $m, b)) ? new $v(this.Bb, this.Cb, this.Gb, c, this.Lb, this.sa, this.ca, null) : z(Y.j ? Y.j(Vm, b) : Y.call(null, 
  Vm, b)) ? new $v(this.Bb, this.Cb, this.Gb, this.Fb, c, this.sa, this.ca, null) : new $v(this.Bb, this.Cb, this.Gb, this.Fb, this.Lb, this.sa, U.l(this.ca, b, c), null);
};
h.da = function() {
  return x(Nf.j(new V(null, 5, 5, W, [new V(null, 2, 5, W, [Bl, this.Bb], null), new V(null, 2, 5, W, [Nm, this.Cb], null), new V(null, 2, 5, W, [Rk, this.Gb], null), new V(null, 2, 5, W, [$m, this.Fb], null), new V(null, 2, 5, W, [Vm, this.Lb], null)], null), this.ca));
};
h.S = function(a, b) {
...
function bw(a) {
  for (;;) {
    ...
    if (z(function() {
      var a = e;
      return z(a) ? (a = c, z(a) ? M.j(Qk, d) || e instanceof d : a) : a;
    }())) {
      a[1] = c;
      a[2] = e;
      a[5] = null;
      a[4] = U.A(b, Bl, null, S([Nm, null], 0));
      break;
    }
    if (z(function() {
      var a = e;
      return z(a) ? nc(c) && nc(Rk.h(b)) : a;
    }())) {
      a[4] = Vm.h(b);
    } else {
      if (z(function() {
        var a = e;
        return z(a) ? (a = nc(c)) ? Rk.h(b) : a : a;
      }())) {
        a[1] = Rk.h(b);
        a[4] = U.l(b, Rk, null);
        break;
...
;function jw(a) {
  "undefined" === typeof mv && (mv = function(a, c, d) {
    ...
    return new V(null, 3, 5, W, [Lo, pk, ko], null);
  }, mv.Db = !0, mv.ob = "cljs.core.async/t_cljs$core$async61263", mv.Rb = function(a, c) {
    return qd(c, "cljs.core.async/t_cljs$core$async61263");
  });
...
var qw = function qw() {
  ...
  "undefined" === typeof nv && (nv = function(b, d, e) {
    ...
    return function() {
      return new V(null, 3, 5, W, [xe(Tl, new q(null, 2, [zk, !0, $f, xf(ag, xf(De))], null)), em, fl], null);
    };
  }(b), nv.Db = !0, nv.ob = "cljs.core.async/t_cljs$core$async61308", nv.Rb = function() {
    return function(b, d) {
      return qd(d, "cljs.core.async/t_cljs$core$async61308");
    };
  }(b));
  ...
  "undefined" === typeof ov && (ov = function(b, c, f, g) {
    ...
    return new V(null, 4, 5, W, [xe(Gn, new q(null, 2, [zk, !0, $f, xf(ag, xf(new V(null, 2, 5, W, [em, Tk], null)))], null)), em, Tk, Qm], null);
  }, ov.Db = !0, ov.ob = "cljs.core.async/t_cljs$core$async61314", ov.Rb = function(b, c) {
    return qd(c, "cljs.core.async/t_cljs$core$async61314");
  });
...
function sw(a, b, c) {
  ...
  return z(k) ? k : Ze(c, Qk) && (k = function() {
    var a = sv(d);
    return z(a) ? tv(d) : a;
  }(), z(k)) ? Mv(new V(null, 2, 5, W, [Qk.h(c), Qk], null)) : null;
}
function tw(a, b) {
  var c = kw(1);
  Jv(function(c) {
...
function Cw(a) {
  ...
  a = H.j(b, rm);
  var d = H.j(b, Dk), b = Hn.h(b), b = z(b) ? b : 0, c = null == c ? !0 : c, e = new hr;
  Aw(e, a);
  Bw(e, d);
  e.cd = Math.max(0, b);
  e.ef = c;
...
var Dw = Fe([0, 7, 1, 4, 6, 3, 2, 9, 5, 8], [gm, Rl, uo, mo, am, zm, jk, Nj, wn, Hn]);
function Ew(a) {
  var b = null != a && (a.v & 64 || a.R) ? Rf(qg, a) : a, c = H.j(b, wo), d = H.j(b, cm), e = H.j(b, Qn), f = H.j(b, tm), g = H.j(b, vn), k = H.j(b, Nn), l = kw(null), n = fv(b), m = Cf(z(c) ? c : Zj), r = hv(d), t = Cw(b);
  tg.J(yw, U, l, t);
  uq(t, "complete", function(a, b, c, d, e, f, g, k, l, m, n, r, t) {
    return function(c) {
      ...
      c = new q(null, 7, [Im, d, Am, f, Qn, g, cm, k, qo, l, hm, m, an, ha(c.pc) ? c.pc : String(c.pc)], null);
  ...
  if (z(k)) {
    var u = function(a, b, c, d, e, f, g, k, l, m, n, r, t, u) {
      return function(a, b) {
        return ow(u, Ai.A(S([new q(null, 2, [so, a, pl, b.loaded], null), z(b.lengthComputable) ? new q(null, 1, [sm, b.total], null) : null], 0)));
      };
    }(l, n, m, r, t, a, b, b, c, d, e, f, g, k);
    t.Vf = !0;
...
function Fw(a) {
  var b = null != a && (a.v & 64 || a.R) ? Rf(qg, a) : a, c = H.j(b, Hn), d = H.j(b, gl), e = H.j(b, vn), f = H.l(b, ro, !0), g = kw(null), k = new qs(fv(b), d);
  k.vc = c;
  var l = k.send(null, function(a, b, c, d, e, f, g, k, l) {
    return function(b) {
      b = new q(null, 3, [Im, 200, Am, !0, Qn, jj(b, S([kj, l], 0))], null);
      ow(a, b);
      tg.l(yw, Ge, a);
      z(k) && rv(k);
      return rv(a);
...
function Hw(a) {
  ...
  return new q(null, 6, [oo, c, Dn, a.ac, dm, z(z(d) ? 0 < d : d) ? d : null, zn, a.Vb, Ln, nc(b.Re()) ? "" + E(b) : null, dn, nc(b.Re()) ? Gw("" + E(b)) : null], null);
}
function Iw(a, b) {
...
function Lw(a, b, c, d) {
  c = (d = Wf.j(mm, d)) ? (d = Wf.j(204, Im.h(a))) ? Oi(Pi([E("(?i)"), E(ff(E, Gi(c)))].join("")), "" + E(H.l(cm.h(a), "content-type", ""))) : d : d;
  return z(c) ? Lg.l(a, new V(null, 1, 5, W, [Qn], null), b) : a;
}
function Mw(a, b) {
  var c = T(b, 0, null);
  return function(b, c) {
...
function Nw(a, b) {
  ...
  return function(b, c) {
    return function(b) {
      ...
      d = Ho.h(b);
      d = z(d) ? d : c;
      z(d) && (b = Kg(b, new V(null, 2, 5, W, [cm, "accept"], null), d));
      return a.h ? a.h(b) : a.call(null, b);
    };
  }(b, c);
}
function Ow(a, b) {
  ...
  return function(b, c) {
    return function(b) {
      ...
      d = gn.h(b);
      d = z(d) ? d : c;
      z(d) && (b = Kg(b, new V(null, 2, 5, W, [cm, "content-type"], null), d));
      return a.h ? a.h(b) : a.call(null, b);
    };
  }(b, c);
}
var Pw = new q(null, 4, [Ij, Fn, bl, cg, Cn, Fn, Mm, cg], null);
function Qw(a) {
  var b = new FormData;
  a = x(a);
  for (var c = null, d = 0, e = 0;;) {
...
function Rw(a, b) {
  ...
  return function(b, c) {
    return function(b) {
      ...
      b = Ge.j(b, fo);
      k = new V(null, 2, 5, W, [cm, "authorization"], null);
      if (z(d)) {
        var l = Oe(d) ? wg.j(d, new V(null, 2, 5, W, [jl, Mk], null)) : d;
        d = T(l, 0, null);
        l = T(l, 1, null);
...
var Sw = function(a) {
  ...
  return function(b) {
    var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, dn), e = Hw(Ym.h(c));
    return z(e) ? (b = Lg.l(Ge.j(Ai.A(S([c, e], 0)), Ym), new V(null, 1, 5, W, [dn], null), function(a, b, c, d, e, m) {
      return function(a) {
        return Ai.A(S([a, m], 0));
      };
  ...
  return function(b) {
    var c = Pk.h(b);
    z(c) && (b = U.l(Ge.j(b, Pk), wo, c));
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  return function(b) {
    var c = kn.h(b);
    z(c) && (b = Kg(Ge.j(b, kn), new V(null, 2, 5, W, [cm, "authorization"], null), [E("Bearer "), E(c)].join("")));
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
  ...
  return function(b) {
    ...
    var c = H.j(b, dn);
    z(c) && (b = U.l(Ge.j(b, dn), Ln, Mo("\x26", wg.j(Kw, c))));
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
  ...
  return function(b) {
    var c = ck.h(b);
    if (z(c)) {
      var d = Ai.A(S([new q(null, 1, ["content-type", "application/json"], null), cm.h(b)], 0));
      b = U.l(U.l(Ge.j(b, ck), Qn, kv(c)), cm, d);
    }
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  return function(b) {
    var c = Ai.A(S([Pw, Kn.h(b)], 0)), d = null != c && (c.v & 64 || c.R) ? Rf(qg, c) : c, e = H.j(d, Cn), f = H.j(d, Mm);
  ...
  return function(b) {
    var c = Nk.h(b);
    if (z(c)) {
      var d = Ai.A(S([Pw, Kn.h(b)], 0)), e = null != d && (d.v & 64 || d.R) ? Rf(qg, d) : d, d = H.j(e, Ij), e = H.j(e, bl), f = Ai.A(S([new q(null, 1, ["content-type", "application/transit+json"], null), cm.h(b)], 0));
      b = U.l(U.l(Ge.j(b, Nk), Qn, iv(c, d, e)), cm, f);
    }
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  ...
  return function(b) {
    var c = ao.h(b);
    if (z(c)) {
      var d = Ai.A(S([new q(null, 1, ["content-type", "application/edn"], null), cm.h(b)], 0));
      b = U.l(U.l(Ge.j(b, ao), Qn, aj(S([c], 0), bc())), cm, d);
    }
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  return function(b) {
    b = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b;
    var c = H.j(b, jo), d = H.j(b, wo);
    z(z(c) ? (new Ci(null, new q(null, 4, [tk, null, Cl, null, mn, null, En, null], null), null)).call(null, d) : c) && (b = U.l(Ge.j(b, jo), Qn, Qw(c)));
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  return function(b) {
    b = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b;
    var c = H.j(b, Cm), d = H.j(b, wo), e = H.j(b, cm);
    z(z(c) ? (new Ci(null, new q(null, 4, [tk, null, Cl, null, mn, null, En, null], null), null)).call(null, d) : c) && (d = Ai.A(S([new q(null, 1, ["content-type", "application/x-www-form-urlencoded"], null), e], 0)), b = U.l(U.l(Ge.j(b, Cm), Qn, Mo("\x26", wg.j(Kw, c))), cm, d));
    return a.h ? a.h(b) : a.call(null, b);
  };
}(function(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
...
function Tw(a, b) {
  var c = T(b, 0, null), c = Ai.A(S([c, new q(null, 2, [Pk, Zj, Ym, a], null)], 0));
  ...
  for (a = Yd(a);;) {
    ...
    if (!z(d.j ? d.j("", e) : d.call(null, "", e)) && !z(d.j ? d.j(".", e) : d.call(null, ".", e))) {
      if (z(d.j ? d.j("..", e) : d.call(null, "..", e))) {
        ...
        b = M.j(nl, c) ? Ce.j(b, "..") : M.j("..", c) ? Ce.j(b, "..") : M.j(Hm, c) ? b : null == b ? null : Vc(b);
      } else {
        b = Ce.j(b, c);
      }
    }
...
h.V = function(a, b, c) {
  ...
  }(this), "#cemerick.url.URL{", ", ", "}", c, Nf.j(new V(null, 8, 5, W, [new V(null, 2, 5, W, [Fk, this.protocol], null), new V(null, 2, 5, W, [jl, this.username], null), new V(null, 2, 5, W, [Mk, this.password], null), new V(null, 2, 5, W, [pm, this.host], null), new V(null, 2, 5, W, [Ol, this.port], null), new V(null, 2, 5, W, [Gj, this.path], null), new V(null, 2, 5, W, [Jn, this.Wa], null), new V(null, 2, 5, W, [Bn, this.anchor], null)], null), this.ca));
};
h.mb = function() {
  return new uh(0, this, 8, new V(null, 8, 5, W, [Fk, jl, Mk, pm, Ol, Gj, Jn, Bn], null), Id(this.ca));
};
h.O = function() {
  return this.sa;
};
...
h.Tc = function(a, b) {
  return Ze(new Ci(null, new q(null, 8, [Gj, null, Fk, null, Mk, null, jl, null, Ol, null, pm, null, Bn, null, Jn, null], null), null), b) ? Ge.j(xe(Ig.j(cg, this), this.sa), b) : new dx(this.protocol, this.username, this.password, this.host, this.port, this.path, this.Wa, this.anchor, this.sa, Xf(Ge.j(this.ca, b)), null);
};
h.Qb = function(a, b, c) {
  return z(Y.j ? Y.j(Fk, b) : Y.call(null, Fk, b)) ? new dx(c, this.username, this.password, this.host, this.port, this.path, this.Wa, this.anchor, this.sa, this.ca, null) : z(Y.j ? Y.j(jl, b) : Y.call(null, jl, b)) ? new dx(this.protocol, c, this.password, this.host, this.port, this.path, this.Wa, this.anchor, this.sa, this.ca, null) : z(Y.j ? Y.j(Mk, b) : Y.call(null, Mk, b)) ? new dx(this.protocol, this.username, c, this.host, this.port, this.path, this.Wa, this.anchor, this.sa, this.ca, null) : 
  z(Y.j ? Y.j(pm, b) : Y.call(null, pm, b)) ? new dx(this.protocol, this.username, this.password, c, this.port, this.path, this.Wa, this.anchor, this.sa, this.ca, null) : z(Y.j ? Y.j(Ol, b) : Y.call(null, Ol, b)) ? new dx(this.protocol, this.username, this.password, this.host, c, this.path, this.Wa, this.anchor, this.sa, this.ca, null) : z(Y.j ? Y.j(Gj, b) : Y.call(null, Gj, b)) ? new dx(this.protocol, this.username, this.password, this.host, this.port, c, this.Wa, this.anchor, this.sa, this.ca, 
  null) : z(Y.j ? Y.j(Jn, b) : Y.call(null, Jn, b)) ? new dx(this.protocol, this.username, this.password, this.host, this.port, this.path, c, this.anchor, this.sa, this.ca, null) : z(Y.j ? Y.j(Bn, b) : Y.call(null, Bn, b)) ? new dx(this.protocol, this.username, this.password, this.host, this.port, this.path, this.Wa, c, this.sa, this.ca, null) : new dx(this.protocol, this.username, this.password, this.host, this.port, this.path, this.Wa, this.anchor, this.sa, U.l(this.ca, b, c), null);
};
h.da = function() {
  return x(Nf.j(new V(null, 8, 5, W, [new V(null, 2, 5, W, [Fk, this.protocol], null), new V(null, 2, 5, W, [jl, this.username], null), new V(null, 2, 5, W, [Mk, this.password], null), new V(null, 2, 5, W, [pm, this.host], null), new V(null, 2, 5, W, [Ol, this.port], null), new V(null, 2, 5, W, [Gj, this.path], null), new V(null, 2, 5, W, [Jn, this.Wa], null), new V(null, 2, 5, W, [Bn, this.anchor], null)], null), this.ca));
};
h.S = function(a, b) {
...
;function kx(a, b) {
  ...
  return "" + E(Kg(c, new V(null, 2, 5, W, [Jn, Cf(Bk)], null), b));
}
function lx(a, b) {
  return function(c) {
    return function() {
      ...
      var d = function() {
        return function(a) {
          ...
          return function(b) {
            ...
            if (2 === c) {
              return c = [E("https://gist.githubusercontent.com/"), E(a), E("/raw"), E("?"), E(1 * Math.random())].join(""), d = Fe([tm], [!1]), d = Tw(c, S([d], 0)), b[8] = c, Xv(b, 5, d);
            }
            if (11 === c) {
            ...
            if (14 === c) {
              var d = b[2], c = H.j(d, Im), d = H.j(d, Qn), e = !M.j(c, 200);
              b[10] = d;
              b[7] = c;
              b[1] = e ? 15 : 16;
              return Z;
...
function qx(a, b) {
  var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, gc), e = H.j(c, cl), f = a.dataset, c = nx(f.staticFns, !1), g = nx(f.evalContext, null), d = nx(f.printLength, d), e = nx(f.beautifyStrings, e), f = f.externalLibs, f = z(f) ? f : null, f = z(f) ? wg.j(Ro, Po(f, ",")) : null;
  return new q(null, 5, [ik, c, gc, d, Vj, f, ln, g, cl, e], null);
}
;function rx(a) {
...
function Cx(a, b, c, d) {
  var e = null != c && (c.v & 64 || c.R) ? Rf(qg, c) : c, f = H.j(e, ol), g = null != d && (d.v & 64 || d.R) ? Rf(qg, d) : d, k = H.l(g, ml, !0), l = function() {
    var b = function() {
      return function(b) {
        var c = a.parentNode;
...
;function Ex(a, b) {
  var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, Vk), e = H.j(c, fk), f = H.l(c, Sl, null);
  wx(a, lx(d, e));
...
var Yx = function Yx(b) {
  var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, Io), e = H.j(c, Jj), f = H.j(c, Kj), g = H.j(c, Tj), k = H.j(c, Wj), l = H.j(c, nk), n = H.j(c, dl), m = H.j(c, om), r = H.j(c, Tm), t = H.j(c, en), u = H.j(c, rn), v = Rf(vg, k), y = Ii(Nf.j(r, l), Nf.j(n, t)), B = function(b, c) {
    return function(b) {
  ...
  "undefined" === typeof Fx && (Fx = function(b, c, d, e, f, g, k, l, m, n, r, t, u, v, y, B, G, kb, rb, lb) {
    ...
    return function(b, c) {
      return new Fx(this.$g, this.he, this.mh, this.dh, this.Ec, this.fh, this.Ig, this.kf, this.Kg, this.ah, this.eh, this.lh, this.Hg, this.jh, this.id, this.kh, this.bh, this.Gg, this.gh, c);
    };
    ...
    return function() {
      return new V(null, 20, 5, W, [xk, xe(Gk, new q(null, 3, [Nl, !0, $f, xf(ag, xf(new V(null, 1, 5, W, [new q(null, 2, [ym, new V(null, 11, 5, W, [Kk, Lk, kl, Al, fm, sn, Zn, no, Ko, xk, el], null), Zk, ul], null)], null))), Un, "Do not call this directly, use 'spec' with a map argument"], null)), Kk, Lk, el, kl, ll, ul, vl, Al, El, fm, Sm, sn, Mn, Zn, no, Bo, Ko, nm], null);
    };
  }(v, y, B, G, b, c, c, d, e, f, g, k, l, n, m, r, t, u), Fx.Db = !0, Fx.ob = "cljs.spec/t_cljs$spec66107", Fx.Rb = function() {
    return function(b, c) {
      return qd(c, "cljs.spec/t_cljs$spec66107");
    };
  }(v, y, B, G, b, c, c, d, e, f, g, k, l, n, m, r, t, u));
  return new Fx(d, Yx, e, f, g, k, v, c, c, l, b, n, B, m, G, r, t, y, u, cg);
};
function Wx(a) {
  for (var b = [], c = arguments.length, d = 0;;) {
    if (d < c) {
...
function Zx(a, b, c, d, e) {
  ...
  "undefined" === typeof Gx && (Gx = function(a, b, c, d, e, m) {
    ...
    return new V(null, 6, 5, W, [Dj, Gl, el, rl, Mj, Zl], null);
  }, Gx.Db = !0, Gx.ob = "cljs.spec/t_cljs$spec66149", Gx.Rb = function(a, b) {
    return qd(b, "cljs.spec/t_cljs$spec66149");
  });
...
var $x = function $x(b) {
  ...
  var e = I(b);
  b = K(b);
  var f = H.j(c, Ik), g = x(f), k = I(g), g = K(g), l = H.j(c, xo), n = x(l);
  I(n);
  ...
  if (dg(hf, d)) {
    ...
    r = H.j(r, bo);
    r = M.j(cn, r);
    return z(r) ? (d = Qj.h(e), d = Ce.j(m, z(f) ? Fh([k, d], !0, !1) : d), b ? $x(new q(null, 4, [Ao, b, Ik, g, xo, n, Qj, d], null)) : new q(null, 2, [bo, cn, Qj, d], null)) : new q(null, 6, [bo, Wl, Ao, d, Qj, m, Ik, f, xo, l, ek, c], null);
  }
  return null;
};
function ay(a, b, c) {
  return $x(new q(null, 4, [Ik, a, Ao, b, xo, c, Qj, cg], null));
}
var Sx = function Sx(b, c) {
  "undefined" === typeof Hx && (Hx = function(b, c, f, g) {
    ...
    return new V(null, 4, 5, W, [xe(dk, new q(null, 3, [Nl, !0, $f, xf(ag, xf(new V(null, 2, 5, W, [km, el], null))), Un, "Do not call this directly, use 'spec' with a regex op argument"], null)), km, el, on], null);
  }, Hx.Db = !0, Hx.ob = "cljs.spec/t_cljs$spec66633", Hx.Rb = function(b, c) {
    return qd(c, "cljs.spec/t_cljs$spec66633");
  });
  ...
  "undefined" === typeof Ix && (Ix = function(b, c, d, e, f, g, k, l, G, D) {
    ...
    return function() {
      return new V(null, 10, 5, W, [xe(Lm, new q(null, 3, [Nl, !0, $f, xf(ag, xf(new V(null, 7, 5, W, [yk, ok, bn, qn, hl, zl, el], null))), Un, "Do not call this directly, use 'fspec'"], null)), yk, ok, bn, qn, hl, zl, el, Vn, co], null);
    };
  }(l), Ix.Db = !0, Ix.ob = "cljs.spec/t_cljs$spec66649", Ix.Rb = function() {
    return function(b, c) {
      return qd(c, "cljs.spec/t_cljs$spec66649");
    };
  }(l));
  return new Ix(by, b, c, d, e, f, g, k, l, cg);
};
Xx(Do, xf($l, xf(Fm, new V(null, 1, 5, W, [Yn], null), xf(Pl, xf(Yl, Ck, Yn), xf(Yl, eo, Yn))), xf(Fm, new V(null, 1, 5, W, [Ok], null), xf(Yl, xf(Xm, new V(null, 1, 5, W, [new V(null, 2, 5, W, [Um, il], null)], null), new q(null, 2, [Ck, Um, eo, il], null)), Ok))), Zx(xf(Fm, new V(null, 1, 5, W, [Yn], null), xf($k, xf(ak, Ck, Yn), xf(ak, eo, Yn))), function(a) {
  return Ii(wg.j(Ck, a), wg.j(eo, a));
}, null, !0, function(a) {
  return wg.j(function(a) {
    var c = T(a, 0, null);
    a = T(a, 1, null);
    return new q(null, 2, [Ck, c, eo, a], null);
  }, a);
}));
...
;function ey() {
  var a = new q(null, 2, [Uj, 0, zo, kw(null)], null);
      ...
      var k = function() {
        return function(a) {
          ...
          return function(g) {
                    ...
                    var J = function() {
                      return function(a) {
                        ...
                        return function(e) {
                          ...
                          return 3 === g ? Zv(e, e[2]) : 4 === g ? (k = e[2], g = T(k, 0, null), k = T(k, 1, null), k = M.j(k, f), g = M.j(g, Ek), e[1] = z(k && g) ? 5 : 6, Z) : 5 === g ? (e[2] = null, e[1] = 7, Z) : 6 === g ? (g = a.h ? a.h(b) : a.call(null, b), Xv(e, 8, g)) : 7 === g ? (e[2] = e[2], e[1] = 3, Z) : 8 === g ? (g = e[2], g = c.h ? c.h(g) : c.call(null, g), e[7] = g, e[2] = null, e[1] = 2, Z) : null;
                        };
            ...
            if (13 === k) {
              var G = g[11], l = g[2], u = tg.J(e, Lg, new V(null, 1, 5, W, [Uj], null), ge), R = a.h ? a.h(b) : a.call(null, b);
              g[14] = l;
              g[15] = u;
              g[11] = R;
              return Xv(g, 14, R);
            ...
            if (17 === k) {
              var v = g[8], y = g[9], B = g[10], G = g[11], D = g[12], wa = g[2], J = kw(1), l = Jv(function() {
                ...
                }(D, y, B, G, v, J, v, y, B, G, D, wa, J, k, f);
              }());
              g[16] = l;
              g[17] = wa;
              return Zv(g, J);
            }
            return 3 === k ? (g[2] = !1, g[1] = 4, Z) : 12 === k ? (y = g[9], l = ow(y, Ek), g[2] = l, g[1] = 13, Z) : 2 === k ? (l = g[7], u = l.R, g[1] = z(l.v & 64 || u) ? 5 : 6, Z) : 11 === k ? (g[2] = null, g[1] = 13, Z) : 9 === k ? (l = g[7], g[2] = l, g[1] = 10, Z) : 5 === k ? (g[2] = !0, g[1] = 7, Z) : 14 === k ? (v = g[8], l = g[2], u = c.h ? c.h(l) : c.call(null, l), g[8] = l, g[18] = u, g[1] = z(d) ? 15 : 16, Z) : 16 === k ? (g[2] = null, g[1] = 17, Z) : 10 === k ? (B = g[10], D = g[12], 
            l = g[2], y = H.j(l, zo), u = H.j(l, Uj), g[9] = y, g[10] = u, g[12] = l, g[1] = z(0 === u) ? 11 : 12, Z) : 8 === k ? (l = g[7], l = Rf(qg, l), g[2] = l, g[1] = 10, Z) : null;
          };
        }(f), f);
      }(), l = function() {
...
Xx(lk, Ll, Oe);
Xx(wk, al, oc);
Xx(Wm, xf(Sn, Fj, xf(nn, Vl, wk, uk, wk, Hj, lk, pn, lk)), by(Vx(xf(nn, Vl, wk, uk, wk, Hj, lk, pn, lk), ay(new V(null, 4, 5, W, [Vl, uk, Hj, pn], null), new V(null, 4, 5, W, [wk, wk, lk, lk], null), new V(null, 4, 5, W, [wk, wk, lk, lk], null)), null, null), xf(nn, Vl, wk, uk, wk, Hj, lk, pn, lk), null, null, null, null, null));
var iy = new q(null, 2, [Wk, !0, xn, "overlay"], null);
function jy(a, b, c, d) {
  return new V(null, 2, 5, W, [Ai.A(S([U.l(iy, ol, a), c], 0)), Ai.A(S([U.A(iy, ol, b, S([Em, !0], 0)), d], 0))], null);
}
...
zj(Go, function(a, b) {
  var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, In), e = H.j(c, Co), f = H.j(c, Sj), g = H.j(c, fk), k = H.j(c, hk), l = H.j(c, sk), n = H.j(c, Ak), m = H.j(c, ml), r = H.j(c, Xl), t = H.j(c, Km), u = H.j(c, Zm), v = jy(u, n, e, t), y = T(v, 0, null), B = T(v, 1, null), G = rx(l), D = Cx(l, r, y, S([ml, m], 0)), L = ey();
  Ex(D, new q(null, 2, [fk, g, Vk, function(a, b, c, d, e, f, g, k, l, n, m, r, t) {
    return function() {
      return hy(l, d, e, t, f);
    };
...
zj(Ej, function(a, b) {
  var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, In), e = H.j(c, Co), f = H.j(c, Sj), g = H.j(c, fk), k = H.j(c, hk), l = H.j(c, sk), n = H.j(c, Ak), m = H.j(c, ml), r = H.j(c, Xl), t = H.j(c, Km), u = H.j(c, Zm), v = jy(u, n, e, t), y = T(v, 0, null), B = T(v, 1, null), G = Dx(l, f, B), D = Cx(l, r, y, S([ml, m], 0)), L = ey();
  Ex(D, new q(null, 2, [fk, g, Vk, function(a, b, c, d, e, f, g, k, l, n, m, r, t, u, v) {
    return function() {
...
zj(yo, function(a, b) {
  var c = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, d = H.j(c, sk), e = H.j(c, On), f = H.j(c, Xl), g = H.j(c, fn), k = H.j(c, In), l = H.j(c, Sj), n = H.j(c, fk), m = H.j(c, hk), r = rx(d), t = ey();
  is(r, l);
...
function ry(a, b, c) {
  var d = null != b && (b.v & 64 || b.R) ? Rf(qg, b) : b, e = H.l(d, to, 20), f = H.l(d, Ql, !1), g = H.j(d, tl), k = H.l(d, Jk, 1E3), l = H.l(d, xm, !1), n = H.l(d, ho, cg), m = H.l(d, Rj, cg), r = null != c && (c.v & 64 || c.R) ? Rf(qg, c) : c, t = H.j(r, Zm), u = H.j(r, Ak), v = H.j(r, In), y = H.j(r, Kl), B = H.l(r, ml, !0), G = H.l(r, Dl, 0), D = kw(1);
      ...
      var lb = function() {
        return function(a) {
          ...
          return function(D) {
            ...
            if (2 === L) {
              var ka = [gc, cl], sa = [k, l], wa = Fe(ka, sa), xa = qx(a, wa), ea = function() {
            ...
            if (14 === L) {
              var ea = D[8], R = D[9], pa = D[2], ta = H.j(pa, fk), Ra = H.j(pa, qk), pa = H.j(pa, hk), Ra = qy(f, Ra), R = Fe([Sj, fk, hk, sk, Ak, ml, Xl, Km, Zm, In, Co], [";the evaluation will appear here (soon)...", ta, pa, a, v, G, R, m, u, ea, n]), R = Aj.j ? Aj.j(Ra, R) : Aj.call(null, Ra, R);
              D[2] = R;
              D[1] = 4;
              return Z;
            }
...
Xx(Yj, bm, function(a) {
  var b = ia(a);
  return b ? b : null != a ? a.jg ? !0 : a.Ge ? !1 : A(wc, a) : A(wc, a);
});
Xx(un, al, oc);
Xx(vk, vm, Ye);
Xx(Pm, xf(Xm, new V(null, 1, 5, W, [Ul], null), xf(po, xf(gk, Ul, !0), xf(gk, Ul, !1))), function(a) {
  return M.j(a, !0) || M.j(a, !1);
});
Xx(Bm, xf(Lj, Jj, new V(null, 4, 5, W, [io, lo, Yj, un], null)), Yx(Fe([Jj, Kj, Tj, Wj, nk, dl, om, Tm, en, rn, Io], [new V(null, 4, 5, W, [io, lo, Yj, un], null), null, null, new V(null, 5, 5, W, [Oe, function(a) {
  return Ze(a, Zm);
}, function(a) {
  return Ze(a, Ak);
}, function(a) {
  ...
  return Ze(a, Kl);
}], null), De, new V(null, 4, 5, W, [io, lo, Yj, un], null), null, new V(null, 4, 5, W, [Zm, Ak, In, Kl], null), De, new V(null, 5, 5, W, [Ll, xf(Xm, new V(null, 1, 5, W, [Ul], null), xf(Jl, Ul, Zm)), xf(Xm, new V(null, 1, 5, W, [Ul], null), xf(Jl, Ul, Ak)), xf(Xm, new V(null, 1, 5, W, [Ul], null), xf(Jl, Ul, In)), xf(Xm, new V(null, 1, 5, W, [Ul], null), xf(Jl, Ul, Kl))], null), null])));
Xx(Xk, xf(Lj, Kj, new V(null, 2, 5, W, [vk, Pm], null)), Yx(Fe([Jj, Kj, Tj, Wj, nk, dl, om, Tm, en, rn, Io], [null, new V(null, 2, 5, W, [vk, Pm], null), null, new V(null, 1, 5, W, [Oe], null), new V(null, 2, 5, W, [to, Ql], null), De, null, De, new V(null, 2, 5, W, [vk, Pm], null), new V(null, 1, 5, W, [Ll], null), null])));
Xx(lm, xf(Sn, Fj, xf(nn, sk, Fo, wl, Xk, Om, Bm)), by(Vx(xf(nn, sk, Fo, wl, Xk, Om, Bm), ay(new V(null, 3, 5, W, [sk, wl, Om], null), new V(null, 3, 5, W, [Fo, Xk, Bm], null), new V(null, 3, 5, W, [Fo, Xk, Bm], null)), null, null), xf(nn, sk, Fo, wl, Xk, Om, Bm), null, null, null, null, null));
      ...
      var f = function() {
        return function(a) {
          ...
          return function(d) {
            ...
            if (6 === e) {
              return g = d[9], e = x(g), d[7] = e, d[1] = e ? 9 : 10, Z;
            }
            if (3 === e) {
              return e = d[8], f = d[12], d[1] = z(f < e) ? 5 : 6, Z;
            }
            if (12 === e) {
            ...
            return 2 === e ? (g = x(d[2]), d[8] = 0, d[9] = g, d[11] = null, d[12] = 0, d[2] = null, d[1] = 3, Z) : 11 === e ? (d[2] = d[2], d[1] = 7, Z) : 9 === e ? (f = d[7], d[1] = Se(f) ? 12 : 13, Z) : 5 === e ? (r = d[11], f = d[12], e = Ec.j(r, f), e = e.w ? e.w() : e.call(null), Xv(d, 8, e)) : 14 === e ? (d[2] = d[2], d[1] = 11, Z) : 10 === e ? (d[2] = null, d[1] = 11, Z) : 8 === e ? (e = d[8], g = d[9], r = d[11], f = d[12], t = d[2], d[8] = e, d[9] = g, d[11] = r, d[13] = t, d[12] = f + 
...
oy("eval-python-client", "selector_eval_python_client", new q(null, 5, [Zm, "python", Ak, "python", In, function(a) {
...
oy("eval-scheme", "selector_eval_scheme", new q(null, 4, [Zm, "scheme", Ak, "scheme", In, function(a) {
...
oy("eval-html", "selector_eval_html", new q(null, 4, [Zm, "text/html", Ak, "text", In, function(a) {
  var b = kw(1);
  Jv(function(b) {
    return function() {
      var d = function() {
...
oy("eval-lambdaway", "selector_eval_lambdaway", new q(null, 4, [Zm, "clojure", Ak, "text", In, function(a) {
  var b = kw(1);
  Jv(function(b) {
    return function() {
      var d = function() {
...
oy("eval-ruby", "selector_eval_ruby", new q(null, 4, [Zm, "ruby", Ak, "ruby", In, function(a) {
  var b = kw(1);
  Jv(function(b) {
    return function() {
      var d = function() {
      ...
      var d = function() {
        return function(a) {
          ...
          return function(b) {
            ...
            return 15 === c ? (c = b[7], b[2] = c, b[1] = 16, Z) : 13 === c ? (b[2] = b[2], b[1] = 10, Z) : 6 === c ? (b[2] = b[2], b[1] = 3, Z) : 17 === c ? (d = b[8], e = b[9], c = b[11], e = console.info("evaluating:", e), c = Cy.h ? Cy.h(c) : Cy.call(null, c), d = Yd(d), b[12] = e, b[8] = d, b[13] = c, b[2] = null, b[1] = 2, Z) : 3 === c ? Zv(b, b[2]) : 12 === c ? (b[2] = !1, b[1] = 13, Z) : 2 === c ? (d = b[8], c = x(d), b[1] = c ? 4 : 5, Z) : 19 === c ? (b[2] = b[2], b[1] = 6, Z) : 11 === c ? 
            (b[2] = !0, b[1] = 13, Z) : 9 === c ? (b[2] = !1, b[1] = 10, Z) : 5 === c ? (b[2] = new V(null, 1, 5, W, [Jm], null), b[1] = 6, Z) : 14 === c ? (c = b[7], c = Rf(qg, c), b[2] = c, b[1] = 16, Z) : 16 === c ? (c = b[14], c = b[2], d = H.j(c, Im), c = H.j(c, Qn), e = M.j(200, d), b[14] = d, b[11] = c, b[1] = e ? 17 : 18, Z) : 10 === c ? (b[1] = z(b[2]) ? 14 : 15, Z) : 18 === c ? (c = b[14], e = b[9], b[2] = new V(null, 3, 5, W, [tn, c, e], null), b[1] = 19, Z) : 8 === c ? (c = b[7], d = 
...
oy("eval-javascript", "selector_eval_js", new q(null, 4, [Zm, "javascript", Ak, "javascript", In, function(a, b) {
      ...
      var n = function() {
        return function(a) {
          ...
          return function(b) {
            ...
            if (2 === c) {
              var f = b[2], c = T(f, 0, null), d = T(f, 1, null), f = T(f, 2, null), c = M.j(Jm, c);
              b[7] = f;
              b[8] = d;
              b[1] = c ? 3 : 4;
              return Z;
            ...
            if (4 === c) {
              return f = b[7], d = b[8], d = [E("Cannot load script: "), E(f), E("\n"), E("error: "), E(d)].join(""), b[2] = d, b[1] = 5, Z;
            }
            if (5 === c) {
              return Zv(b, b[2]);
            }
...
oy("eval-markdown", "selector_eval_markdown", new q(null, 4, [Zm, "markdown", Ak, "htmlmixed", In, function(a) {
  var b = kw(1);
  Jv(function(b) {
    return function() {
      var d = function() {
...
;if (z(window.ReplitClient)) {
  for (var Iy = x(new V(null, 3, 5, W, [new q(null, 3, [Pj, "selector_eval_python", Yk, "eval-python", Om, new q(null, 5, [Zm, "python", Ak, "python", Uk, "python3", Kl, "#", ml, !1], null)], null), new q(null, 3, [Pj, "selector_eval_csharp", Yk, "eval-csharp", Om, new q(null, 4, [Zm, "text/x-csharp", Ak, "text/x-csharp", Uk, "csharp", Kl, "#"], null)], null), new q(null, 3, [Pj, "selector_eval_go", Yk, "eval-go", Om, new q(null, 4, [Zm, "go", Ak, "go", Uk, "go", Kl, "//"], null)], null)], null)), 
  Jy = null, Ky = 0, Ly = 0;;) {
    if (Ly < Ky) {
      var My = Jy.Z(null, Ly), Ny = null != My && (My.v & 64 || My.R) ? Rf(qg, My) : My, Oy = H.j(Ny, Pj), Py = H.j(Ny, Yk), Qy = H.j(Ny, Om), Ry = U.l(Ge.j(U.l(Qy, In, ig(Hy, Uk.h(Qy))), Uk), Dl, 3E3);
      oy(Py, Oy, Ry);
      Ly += 1;
    } else {
      var Sy = x(Iy);
      if (Sy) {
        ...
        if (Se(Ty)) {
          ...
          var Yy = I(Ty), Zy = null != Yy && (Yy.v & 64 || Yy.R) ? Rf(qg, Yy) : Yy, $y = H.j(Zy, Pj), az = H.j(Zy, Yk), bz = H.j(Zy, Om), cz = U.l(Ge.j(U.l(bz, In, ig(Hy, Uk.h(bz))), Uk), Dl, 3E3);
          oy(az, $y, cz);
          Iy = K(Ty);
          Jy = null;
          Ky = 0;
...
;function dz(a) {
  a = gj(new q(null, 2, [rk, new V(null, 1, 5, W, [new q(null, 1, [Hl, a], null)], null), Fl, "ADVANCED"], null));
  console.log(a);
...
oy("compile-javascript", "selector_compile_js", new q(null, 5, [Zm, "javascript", Ak, "javascript", In, function(a) {
...
oy("eval-php", "selector_eval_php", new q(null, 4, [Zm, "text/x-php", Ak, "text/x-php", In, function(a) {
  var b = kw(null);
